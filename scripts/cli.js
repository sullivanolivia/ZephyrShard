...
const contractABI = require("../artifacts/contracts/Zephyrshard.sol/Zephyrshard.json").abi;

program
    .name("zephyrshard-cli")
    .description("CLI tool for Zephyrshard smart contract")
    .version("1.0.0");
